      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>BEST WORLDWIDE ONLINE CAR RENTAL SERVICE WITHOUT REFERRING TO ANY CAR RENTAL OFFICES</h1>
            <p>REFERRING TO ANY CAR RENTAL OFFICES </p>
            <a href="car-listing.php" class="btn">Searching For Car<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<!-- /Banners --> 
    ...
    <div class="container-fluid ab">
       <div class="container">
         ...
         <a type="button" class="btn btn-warning" href="How To Works.php">See Details</a>
       </div>
         </div>
